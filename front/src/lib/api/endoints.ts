export const apiRoutes = {
    ...
    collections: {
        list: { method: 'GET', path: '/api/collections' },
        get: { method: 'GET', path: '/api/collections/{collection_id}' },
        create: { method: 'POST', path: '/api/collections' },
        delete: { method: 'DELETE', path: '/api/collections/{collection_id}' },
        getMovie: { method: 'GET', path: '/api/collections/{collection_id}/movies/' },
        addMovie: { method: 'POST', path: '/api/collections/{collection_id}/movies/{movie_id}' },
        removeMovie: { method: 'DELETE', path: '/api/collections/{collection_id}/movies/{movie_id}' },
    },
    watchHistory: {
        list: { method: 'GET', path: '/api/watch-history' },
    },
    genres: {
